 ...
 *  }
	...
	//=======================================   自定义验证方法  =============================================
	/**
	 * Created by 西兰花的春天gcx on 2016/12/27.
	 */
	/**
	 * 自定义正则表达示验证方法
	 * 判断输入框输入是否正确
	 ...
	 * news：            弹出的提示消息
	 */
	$.regular_test = function( object, regular_value, news )
	{
		$.validator.addMethod( object, function( value, element )
		{
	...
	{
		//格式：XXXX-XXXXXXXX，XXXXXXX，XXX-XXXXXXX。
	...
	{
		//格式：+123 -999 999 ； +123-999 999 ；123 999 999 ；+123 999999 ；05718888888
