...
;(function( $, window, document, undefined )
{
	...
	$.extend( {
		...
		{
			var t, tpl = '', footerTpl = '', isLock = false, okText = 'OK', cancelText = 'Cancel', width = 260, margin = '0 0 0 ' + parseInt( -(width / 2) ) + 'px', type = type != undefined ? type : 'alert', time = time != undefined ? parseInt( time ) : 0,
				...
				cancelTpl = '<a href="javascript:;" style="padding:5px 10px;display:inline-block;border-radius:3px;margin-left:10px;background-color:#eee;color:#333;text-decoration:none" id="h_cancel">' + cancelText + '</a>',
